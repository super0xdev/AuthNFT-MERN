    ...
    return (
        <div className="min-h-screen" data-theme="wireframe">
            ...
            <div className="flex flex-col items-center pt-[5%] gap-2">
                <p className="text-2xl pb-4">Input username and password to register</p>
                ...
                <button onClick={handleSubmit} className="bg-blue-500 text-white px-4 py-2 rounded-lg">Register</button>
